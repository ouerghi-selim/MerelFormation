            ...
            <div className="container mx-auto px-4 py-4">
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-4">
                        <Link to="/" className="text-2xl font-bold tracking-tight hover:text-yellow-400 transition-colors duration-300">
                            MerelFormation
                        </Link>
                    </div>
                    ...
                    <nav className="hidden md:flex space-x-8 items-center">
                        ...
                        <Link to="/login" className="bg-yellow-500 hover:bg-yellow-400 text-blue-900 px-5 py-2.5 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 hover:shadow-md">
                            Connexion
                        </Link>
                    </nav>
