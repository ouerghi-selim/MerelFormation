...
class EmailTemplateFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $passwordReset->setName('Réinitialisation de mot de passe');
        $passwordReset->setIdentifier('password_reset_user');
        $passwordReset->setEventType('password_reset');
        $passwordReset->setTargetRole('ROLE_STUDENT');
        $passwordReset->setIsSystem(true);
        $passwordReset->setType('notification');
        $passwordReset->setSubject('Réinitialisation de votre mot de passe - MerelFormation');
        $passwordReset->setContent('
        ...
        ');
        $passwordReset->setVariables(['userName', 'resetUrl', 'expirationTime', 'userEmail']);
