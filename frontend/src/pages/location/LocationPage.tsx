        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-blue-900 text-white py-16">
                <div className="container mx-auto px-4">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6">
                        {getContent('location_hero_title', 'Location Véhicule « double commande »')}
                    </h1>
                    <p className="text-xl mb-8 text-blue-100">
                        {getContent('location_hero_subtitle', 'Véhicule équipé pour l\'examen TAXI & VTC')}
                    </p>
                    <Button
                        ...
                        size="lg"
                    >
                        {getContent('location_hero_cta', 'Réserver un véhicule')}
                    </Button>
                </div>
            </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
                        <h2 className="text-3xl font-bold mb-6">
                            {getContent('location_info_title', 'Examen TAXI-VTC')}
                        </h2>
                        <p className="text-gray-700 mb-6">
                            {getContent('location_info_description', 'Vous passez l\'examen pratique Taxi VTC ? Vous devez vous présenter le jour de l\'examen pratique avec un véhicule équipé des doubles commandes.')}
                        </p>
                        <div className="space-y-4 mb-6">
                            <div className="flex items-start">
                                <CheckCircle className="h-6 w-6 text-green-500 mr-2 mt-1 flex-shrink-0" />
                                <p className="text-gray-700">
                                    {getContent('location_info_taxi_requirements', 'Pour l\'examen TAXI : le véhicule devra obligatoirement être aménagé avec les équipements obligatoires (compteur horo-kilométrique « compteur », lumineux, imprimante)')}
                                </p>
                            </div>
                            <div className="flex items-start">
                                <CheckCircle className="h-6 w-6 text-green-500 mr-2 mt-1 flex-shrink-0" />
                                <p className="text-gray-700">
                                    {getContent('location_info_vtc_requirements', 'Pour l\'examen VTC : seul l\'équipement double commande est obligatoire')}
                                </p>
                            </div>
                        </div>
                        <p className="text-gray-700 font-medium">
                            {getContent('location_info_footer', 'Nous vous proposons la location d\'un véhicule agréé pour l\'examen TAXI VTC à Rennes en Ille et Vilaine')}
                        </p>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
                        <h2 className="text-3xl font-bold mb-6">
                            {getContent('location_booking_title', 'Comment réserver ?')}
                        </h2>
                        <div className="space-y-6">
                            ...
                            >
                                {getContent('location_booking_step1_description', 'Sélectionnez la date et l\'heure de votre examen dans notre calendrier en ligne')}
                            </ReservationStep>
                            ...
                            >
                                {getContent('location_booking_step2_description', 'Remplissez le formulaire avec vos informations et validez votre demande')}
                            </ReservationStep>
                            ...
                            >
                                {getContent('location_booking_step3_description', 'Nous vous contactons sous 24h pour confirmer et finaliser votre réservation')}
                            </ReservationStep>
                        </div>
            ...
            <section className="py-16 bg-gray-50">
                <div className="container mx-auto px-4">
                    <h2 className="text-3xl font-bold mb-12 text-center">
                        {getContent('location_vehicles_title', 'Nos véhicules d\'examen')}
                    </h2>
                        ...
                        <div className="md:flex">
                            ...
                            <div className="md:w-1/2 p-8">
                                <h3 className="text-2xl font-bold mb-4">
                                    {getContent('location_vehicles_model', 'Volkswagen Touran Taxi Auto-École')}
                                </h3>
                                <div className="space-y-4 mb-6">
                                ...
                                <p className="text-gray-700 mb-6">
                                    {getContent('location_vehicles_pricing', 'Des tarifs différents pour préparer au mieux votre passage d\'examen, avec options de location à l\'heure ou à la journée.')}
                                </p>
                                <Button
                                    onClick={() => setShowModal(true)}
                                    variant="primary"
            ...
            <section className="py-16 bg-blue-900 text-white">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-3xl font-bold mb-6">
                        {getContent('location_cta_title', 'Prêt pour votre examen de taxi ?')}
                    </h2>
                    <p className="text-xl mb-8">
                        {getContent('location_cta_description', 'Réservez dès maintenant votre véhicule équipé pour maximiser vos chances de réussite')}
                    </p>
